 ...
 */
export type State<States extends string, TPayload = unknown, TReply = unknown> = {
    /**
     ...
     */
    onMessage: (message: Message<TPayload, TReply>, instance: Instance<States, TPayload, TReply>) => void | Promise<void>;
};
/**
 ...
 */
export type Descriptor<States extends string, TPayload = unknown, TReply = unknown> = {
    /**
 ...
 */
export type Instance<States extends string, TPayload = unknown, TReply = unknown> = {
    /**
 ...
 *   => States = "idle" | "running"
 */
export declare function createFSM<States extends string, TPayload = unknown, TReply = unknown>(descriptor: Descriptor<States, TPayload, TReply>): Instance<States, TPayload, TReply>;
export {};
